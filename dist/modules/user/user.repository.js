...
let UserRepository = class UserRepository {
    ...
    async createBySocial(email, fullName) {
        const newUser = new this.userModel({
            email: email,
            fullName: fullName,
        });
    ...
    async updateManySelectedPlans(userId, update, options) {
        return await this.userModel.updateOne({ _id: userId }, { $set: { 'selectedPlans.$[].isUsing': false } }, options);
    }
};
